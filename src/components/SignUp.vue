<template>
  <section class="flex gap-8 justify-center items-center">
    <base-card class="bg-dark-secondary p-7">
      <form class="flex flex-col justify-center gap-7" @submit.prevent="formSubmit">
        ...
        <div class="flex flex-col justify-center-items-start gap-5">
          ...
          >
            Password
            <p class="text-xs" :class=" passwordCorrect === true ? 'text-green-500' : 'text-red-500'"> [ 6-20 characters, one numeric digit, one UpperCase, one LowerCase ] </p>
          </label>
          <input
            type="text"
            id="password"
